...
const EditNote = ({modals, toggle, updateNote, taskObj}) => {
            ...
            toggle = {toggle}
                >
                    ...
                    <Modal.Footer >
                        ...
                        <Button type='button' variant="primary" onClick={handleUpdate}>Update</Button>
                    </Modal.Footer>
        </Modal>
  )
}
...
function getTodayDate(){
    ...
    return monthName +' '+ day + ', ' + year + ' (Edited)';
}
